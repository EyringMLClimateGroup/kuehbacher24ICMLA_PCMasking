...
from neural_networks.tuning.models_tuning import ModelDescription
...
def generate_single_nn_for_output_list(setup, inputs_list, outputs_list, tuning_params):
    ...
    for output in outputs_list:
        model_description = ModelDescription(
            output, inputs_list, setup.nn_type, pc_alpha=None, threshold=None, setup=setup, tuning_params=tuning_params
        )
