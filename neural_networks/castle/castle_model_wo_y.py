...
class CASTLEAdapted(CASTLEBase):
    ...
    def __init__(self, num_inputs, hidden_layers, activation, rho, alpha, lambda_prediction, lambda_sparsity,
                 lambda_reconstruction, lambda_acyclicity, relu_alpha=0.3, seed=None, name="castle_adapted", **kwargs):
        ...
        input_sub_layers, shared_hidden_layers, output_sub_layers = build_graph(num_input_layers, num_inputs,
        ...
        super(CASTLEAdapted, self).__init__(num_inputs=num_inputs, hidden_layers=hidden_layers,
