...
class VectorMaskNet(ModelBase):
    def __init__(self,
        ...
        super(VectorMaskNet, self).__init__(num_x_inputs=num_x_inputs, hidden_layers=hidden_layers,
    ...
    def get_config(self):
        config = super(VectorMaskNet, self).get_config()
