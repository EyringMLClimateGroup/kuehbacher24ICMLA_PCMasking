...
class TemperatureDecay(keras.callbacks.Callback):
    def __init__(self, initial_temperature, decay_rate, decay_steps, tb_log_dir=""):
        super().__init__()
    ...
    def temperature_decay(self, step):
        return self.initial_temperature * tf.math.pow(self.decay_rate, (step / self.decay_steps))
