...
For debugging purposes, use the evaluation functions in `offline_evaluation`.
"""
import logging
import os
...
@pytest.mark.parametrize("model_diagnostic", ["model_description_pre_mask_net", "model_description_mask_net"])
