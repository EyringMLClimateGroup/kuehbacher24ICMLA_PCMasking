...
JOB_NAME="plot_profiles_71_gumbel_softmax_single_output_crf"
HPC="jsc" # jsc, dkrz
...
display_help() {
  echo ""
  echo "Wrapper for SLURM batch script for plotting profiles."
  echo ""
  echo "Usage: ./plot_profiles_wrapper.sh -h"
  echo ""
  echo " Options:"
